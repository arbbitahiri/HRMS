    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Country>(entity =>
        {
            ...
            entity.HasOne(d => d.InsertedFromNavigation)
                ...
                .HasForeignKey(d => d.InsertedFrom)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Country_AspNetUsers");
        });
        ...
        modelBuilder.Entity<DocumentFor>(entity =>
        {
            entity.Property(e => e.DocumentForId).HasColumnName("DocumentForID");
            ...
            entity.HasOne(d => d.InsertedFromNavigation)
                .WithMany(p => p.DocumentForInsertedFromNavigation)
                .HasForeignKey(d => d.InsertedFrom)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_DocumentFor_AspNetUsers_Inserted");

            entity.HasOne(d => d.UpdatedFromNavigation)
                .WithMany(p => p.DocumentForUpdatedFromNavigation)
                .HasForeignKey(d => d.UpdatedFrom)
                .HasConstraintName("FK_DocumentFor_AspNetUsers_Updated");
        });
        ...
        modelBuilder.Entity<DocumentType>(entity =>
        {
            ...
            entity.HasOne(d => d.DocumentFor)
                .WithMany(p => p.DocumentType)
                .HasForeignKey(d => d.DocumentForId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_DocumentType_DocumentFor");
